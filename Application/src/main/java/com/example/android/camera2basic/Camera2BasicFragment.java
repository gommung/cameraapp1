...
public class Camera2BasicFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        function_layout = (FrameLayout)v.findViewById(R.id.function_layout);
        arrow_button = (ImageButton)v.findViewById(R.id.arrow_upward_button);
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.album_button).setOnClickListener(this);
        view.findViewById(R.id.arrow_upward_button).setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.arrow_upward_button: {

                try {
                    if(function_layout.getVisibility()==View.GONE) {
                        arrow_button.setImageResource(R.drawable.camera_btn_mode_down);
                        function_layout.setVisibility(View.VISIBLE);
                    }
                    else if(function_layout.getVisibility()==View.VISIBLE){
                        arrow_button.setImageResource(R.drawable.camera_btn_mode_up);
